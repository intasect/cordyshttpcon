...
public class ParameterFactory {
	/**
	 * This method creates the parameter list based on the parameters/parameter
	 * XPath.
	 * 
	 * @param connection
	 *            The connection XML.
	 * @param xmi
	 *            The proper XMI to use.
	 * 
	 ...
	 */
	public static Map<String, IParameter> createParameters(int connection,
			XPathMetaInfo xmi) throws ConnectorException {
		Map<String, IParameter> returnValue = new LinkedHashMap<String, IParameter>();

		int[] parameters = XPathHelper.selectNodes(connection, "ns:"
				+ IServerConnection.TAG_PARAMETERS + "/ns:"
				+ IServerConnection.TAG_PARAMETER, xmi);
