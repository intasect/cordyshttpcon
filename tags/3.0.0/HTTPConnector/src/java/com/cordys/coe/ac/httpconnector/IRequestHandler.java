...
/**
 * Interface for a class which converts the SOAP request XML into data which is
...
public interface IRequestHandler {
	 ...
	 * 
	 * @param configXml
	 *            Handler configuration XML from the method configuration.
	 * @param connector
	 *            HTTP Connector instance.
	 * @param method
	 *            MethodConfiguration to which this handler belongs to.
	 * @param xmi
	 ...
	 */
	void initialize(int configXml, IXSLTStore connector,
			IMethodConfiguration method, XPathMetaInfo xmi)
			throws HandlerException;

	/**
	 * Converts the request XML in HTTP method which can be sent using the HTTP
	 * connection.
	 * 
	 * @param requestNode
	 *            Request XML root node.
	 * @param connection
	 *            Current connection.
	 * @param httpClient
	 ...
	 */
	HttpMethod process(int requestNode, IServerConnection connection,
