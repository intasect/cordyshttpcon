...
/**
 * This interface describes a custom parameter. A custom parameter will do complex logic to create
 * post data based on the request.
 *
 * @author  pgussow
 */
public interface ICustomParameter
{
     ...
     *
     * @param   rhp                  The parameter definition.
     * @param   requestNode          The actual request XML.
     * @param   methodConfiguration  The configuration of the currently executing method.
     * @param   serverConnection     The server connection that is being used.
     *
     * @return  The additional post data. Note that the implementing method should make sure
    ...
    String getPostData(IRestHTMLParameter rhp, int requestNode,
                       IMethodConfiguration methodConfiguration, IServerConnection serverConnection)
