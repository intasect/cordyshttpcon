...
/**
 * <p>EasyX509TrustManager unlike default {@link X509TrustManager} accepts self-signed certificates.
 * </p>
 *
 ...
 *          LOG.debug("Server certificate chain:");         for (int i = 0; i < certificates.length;
 * i++) {             LOG.debug("X509Certificate[" + i + "]=" + certificates[i]);         }     }
