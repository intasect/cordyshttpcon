...
public class MethodConfigurationFactory
{
     ...
     */
    private static final CordysLogger LOG = CordysLogger.getCordysLogger(MethodConfigurationFactory.class);
    /**
    ...
    static
    {
        ...
        s_xmi.addNamespaceBinding("ns", HttpConnectorConstants.NS_HTTP_CONNECTOR_IMPL_2_0);
    }

    /**
     * This method creates a new method configuration object based on the current HttpConnector
     * configuration.
     *
     * @param   conn  The HttpConnector that should be used.
     * @param   req   The actual request as it was received.
     *
     ...
     */
    public static IMethodConfiguration createMethodConfiguration(IXSLTStore conn, BodyBlock req)
                                                                 ...
                                                                 HandlerException
    {
        ...
        {
            LOG.debug("Creating method configuration for method " + md.getMethodDN());
        }

        int implementation = md.getImplementation();

        int realImpl = XPathHelper.selectSingleNode(implementation,
                                                    "ns:" + IMethodConfiguration.TAG_IMPLEMENTATION,
                                                    s_xmi);
    ...
    /**
     * This method creates the method configuration based on the implementation XML.
     *
     * @param   conn            The HttpConnector to use.
     * @param   implementation  The actual implementation for the method.
     *
     ...
     * @throws  HandlerException    In case the handler throws any exception.
     */
    public static IMethodConfiguration createMethodConfiguration(IXSLTStore conn,
                                                                 int implementation)
                                                          throws ConnectorException,
                                                                 HandlerException
    {
