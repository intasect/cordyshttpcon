...
/**
 * <p>EasySSLProtocolSocketFactory can be used to creats SSL {@link Socket}s that accept self-signed
 * certificates.</p>
 *
    ...
    implements SecureProtocolSocketFactory
{
     ...
     */
    private static final CordysLogger LOG = CordysLogger.getCordysLogger(EasySSLProtocolSocketFactory.class);
     ...
     * @throws  ConnectTimeoutException  if an timeout occurred.
     */
    ...
    private static SSLContext createEasySSLContext()
    {
        ...
        {
            LOG.log(Severity.ERROR, e.getMessage(), e);
