...
public class JIRAResponseHandler extends StandardResponseHandler
{
     ...
     */
    @Override public int convertResponseToXml(HttpMethod httpMethod,
                                       ...
                                       throws XMLException, ConnectorException, IOException
    {
        ...
        try
        {
            ...
            // Now we use XPath to locate "span" elements that have the errMsg class set.
     ...
     *
     * @param   resNode     The parent response node.
     * @param   httpMethod  The actual HTTP method that was executed.
     * @param   document    The HTML response.
     * @param   doc         The XML document to use.
     *
     ...
     * @param   httpMethod  The actual HTTP method that was executed.
     *
     * @throws  HandlerException          In case the response contains any functional errors.
     * @throws  XPathExpressionException  In case one of the XPaths fail.
     */
                        ...
                        throws HandlerException, XPathExpressionException
    {
        ...
        if (length != 0)
        {
            ...
            HandlerException he = new HandlerException(HandlerExceptionMessages.ERROR_CONVERTING_THE_RESPONSE_TO_PROPER_XML,
        ...
        // There is another possibility of which errors might be returned. There is a td with
        ...
        if (httpMethod.getStatusCode() == 500)
        {
            ...
            he.addAdditionalErrorMessage((String) xpath.evaluate("//pre[@id='stacktrace']/text()",
     ...
     *
     * @param   responseBody  The response HTML.
     *
