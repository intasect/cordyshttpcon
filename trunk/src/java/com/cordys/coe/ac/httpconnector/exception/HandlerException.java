...
{
    /**
     * Holds additional error messages that will be added to the SOAP fault details.
     */
     ...
     * Creates a new HandlerException object.
     *
     * @param  tCause        The root cause for this exception.
     * @param  srMessage     The message for the exception.
     * @param  aoParameters  The parameters for the message.
     */
    public HandlerException(Throwable tCause, IStringResource srMessage, Object... aoParameters)
    {
        super(tCause, srMessage, aoParameters);
    }

    /**
     * This method adds an additional error message which will be placed in the SOAP Fault detail.
     *
     ...
     */
    @Override public Fault toSOAPFault(BodyBlock bbResponse)
    {
